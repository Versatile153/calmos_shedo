...
@section('content')
      ...
      <div class="row justify-content-center">
          <div class="col-md-8">
              <div class="mb-4">
                  <h3 class="mb-2">Withdraw Funds</h3>
                  <p>Withdraw funds using our system's gateway. The requested amount will be deducted from the  wallet balance. You'll just make investments from this wallet.</p>
              </div>
              <div class="text-end mb-3">
                  <a href="/transaction" class="btn btn--secondary btn--smd"><i class="las la-long-arrow-alt-left"></i> Transaction History</a>
              </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" step="any" name="wallet" class="form-control form--control" value="" autocomplete="off" required>
                                        <span class="input-group-text">USD</span>
                                    </div>
                                </div>
                            </div>
