...
<div class="tradingview-widget-container">
  ...
  <head>
      ...
      <title> Calamosassets - Investment Plan</title>
      <meta name="title" Content="Calamosassets - Investment Plan">
      ...
      <meta name="apple-mobile-web-app-title" content="Calamosassets - Investment Plan">

      <meta itemprop="name" content="Calamosassets - Investment Plan">
      ...
      <meta property="og:url" content="https://calamosassets.net/share/plan">
  ...
  <div class="modal fade" id="investModal">
      <div class="modal-dialog modal-dialog-centered modal-content-bg">
          <div class="modal-content">
              ...
              <form action="https://calamosassets.net/share/user/invest" method="post">
                  <input type="hidden" name="_token" value="ITQO104U15d1mo4BlNUOHsx2ZivyjjrxBbcvvFYh">                <input type="hidden" name="plan_id">
